...
Tabulator.prototype._buildElement = function() {
    ...
    if (
        ((options.persistence && this.modExists('persistence', true) && mod.persistence.config.sort) || options.initialSort) &&
    ...
    if (
        ((options.persistence && this.modExists('persistence', true) && mod.persistence.config.filter) || options.initialFilter) &&
